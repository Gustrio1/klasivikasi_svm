        ...
        <table class="table-base w-full min-w-[800px]">
            <thead class="bg-gray-50 border-b border-gray-100">
                <tr>
                    ...
                    <th class="table-th text-center">Input Awal</th>
                ...
                @forelse($hafalan as $index => $item)
                    <tr class="hover:bg-gray-50/70 transition duration-150">
                        ...
                        <td class="table-td text-center">
                            <div class="text-[11px] font-mono tracking-tighter grid grid-cols-2 gap-x-2 gap-y-1 bg-gray-100 p-1.5 rounded-lg border border-gray-200">
                                <span>🗣️ {{ number_format($item->nilai_kelancaran * 100, 0) }}%</span>
                                <span>🔊 {{ number_format($item->nilai_makhraj * 100, 0) }}%</span>
                            </div>
                        </td>
                        <td class="table-td text-center">
