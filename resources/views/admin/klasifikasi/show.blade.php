...
@section('title', 'Detail Klasifikasi (Admin)')
...
<x-page-header
    ...
    :links="[
        ...
        ['label' => 'Hasil Klasifikasi', 'url' => route('admin.hasil-klasifikasi.index')],
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-2 space-y-6">
        ...
        <div class="card p-6 bg-slate-50 border-slate-200">
            ...
            <p class="text-[10px] text-slate-400 mt-4 italic font-medium">Data di atas adalah parameter numerik yang diproses oleh algoritma Support Vector Machine untuk menentukan kelas.</p>
        </div>
    ...
    <div class="space-y-6">
        ...
        <div class="card p-6">
            ...
            <a href="{{ route('admin.siswa.show', $hasil->id_siswa) }}" class="btn-block mt-6 flex items-center justify-center gap-2 p-2 bg-gray-50 hover:bg-gray-100 rounded-lg text-sm font-bold text-gray-600 transition">
